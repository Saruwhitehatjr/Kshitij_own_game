...
class Platform {
    constructor(posX) {
      ...
      this.ry = height-100;   //setting y position where platform will be created to height( is a variable that stores height of canvas)
      ...
      switch(rand)
      {
        case 1:
          ...
          this.spt.scale=5
          this.spt.setCollider("rectangle",0,0,200,200)
          break;

        case 2:
          this.spt.addAnimation("ground1",building2);
          this.spt.scale=5
          this.spt.setCollider("rectangle",0,0,500,150)
          break;
